...
public class VentanaEstudiante extends JFrame {
    ...
    public void AgregarComponentes() {
        ...
        vCarrera.addElement("TecnologÌa en Electricidad");
    ...
    public Estudiante guradarEstudiante() {
        ...
        est.setLaboratorio((String) cmbLaboratorio.getSelectedItem());
        est.setCarrera((String) cmbCarrera.getSelectedItem());
        est.setModulo((String) cmbModulo.getSelectedItem());
        est.setMateria(txtfMateria.getText());
        est.setFecha(txtfFecha.getText());
        est.setHora_Ingreso(txtfHoraIngreso.getText());
        est.setHora_Salida(txtfHoraSalida.getText());
    ...
    public void cargarCampos(Estudiante estudiante) {
        ...
        cmbLaboratorio.setSelectedItem(estudiante.getLaboratorio());
        cmbCarrera.setSelectedItem(estudiante.getCarrera());
        cmbModulo.setSelectedItem(estudiante.getModulo());
        txtfMateria.setText(estudiante.getMateria());
        txtfFecha.setText(estudiante.getFecha());
        txtfHoraIngreso.setText(estudiante.getHora_Ingreso());
        txtfHoraSalida.setText(estudiante.getHora_Salida());
    }
